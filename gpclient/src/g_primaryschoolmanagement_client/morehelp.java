...
public class morehelp extends JInternalFrame
{
...
*/
    ...
    this.jTextArea1.setText("For more help visit us on the link  given above \n or contact us with the info given on the about information...\n Thankyou");
